...
Váltani a applications.propertiesben: spring.profiles.active=*H2database* vagy a program futásának konfigurálásánál a profram argumentekhez: --spring.profiles.active=*profilnév*
